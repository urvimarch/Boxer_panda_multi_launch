...
def launch_setup(context, *args, **kwargs):
    ...
    xacro_file = 'boxer_panda.xacro.urdf'

    
    package_description = "gazebo_ros2_control_demos"
    ...
    robot_state_publisher_node = Node(
            ...
            parameters=[{'frame_prefix': entity_name+'/', 'use_sim_time': True, 'robot_description': ParameterValue(doc.toxml()), 'robot_name': ParameterValue(entity_name)}],
            output="screen"
        )
